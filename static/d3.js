...
svg.selectAll("bar")
  ...
  .attr("y", function(d) { return y(d.Rev); })
  .attr("height", function(d) { return height - y(d.Rev); })
  .attr("fill", function(d){ return '#337ab7' })

var sum = d3.sum(data, function(d) { return d.Rev; }); 
var average = sum/data.length;

var line = d3.svg.line()
  .x(function(d, i) { return x2(d.Rev) + i; })
